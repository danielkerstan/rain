...
data_before <- read_csv(paste0(site, "&mode=&hours=&data_start=", start_date_before, "%2020:49:03&data_end=", end_date_before, "%2020:49:03&tz=US%2FPacific&format_datetime=%25Y-%25m-%25d+%25H%3A%25i%3A%25S&mime=txt&delimiter=comma")) %>% 
  clean_names()
